...
<head>
    ...
    <style>
        ...
        input[type="email"] {
            ...
            /* Lebar diatur oleh inline style, tapi padding dll. seragam */
        }
            ...
            <table>
                <tr>
                    <td colspan="2">
                        ...
                        <input type="text" id="nama" name="nama" style="width: 100%;">
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td style="width: 50%;">
                        ...
                        <input type="text" id="telepon" name="telepon" style="width: 100%;">
                    </td>
                    <td style="width: 50%; padding-left: 15px;">
                        <label for="check_out">Check-out</label>
                        <input type="text" id="check_out" name="check_out" style="width: 100%;">
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%;">
                        <label for="tamu">Jumlah tamu</label>
                        <input type="text" id="tamu" name="tamu" style="width: 100%;">
                    </td>
                    <td class="total-sewa-cell" style="width: 50%; padding-left: 15px;">
                        <b>Total sewa</b><br>
                        Rp. 700.000 (2 malam)
                    </td>
                </tr>
